...
function bulmapress_home_icon($class)
{
	$output = '<a href="' . esc_url( home_url( '/' ) ) . '" class="' . $class . '" rel="home">' .
		'<img src="http://ve12s.us/gaming/wp-content/themes/bulmapress-master/images/200px.png">' . '</a>';
	echo $output;
}
...
function bulmapress_copyright_link($author = 'Video Game Reviews', $url = 'http://ve12s.us/gaming')
{
	$output = '
